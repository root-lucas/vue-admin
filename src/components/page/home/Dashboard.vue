        ...
        return {
            ...
            options: {
                ...
                datasets: [
                    {
                        label: '家电',
                        data: [214, 218, 220, 140, 223, 234, 123],
                    },
                    {
                        label: '百货',
                        data: [124, 178, 190, 115, 180, 201, 188],
                    },
                    {
                        label: '食品',
                        data: [144, 198, 150, 235, 120, 129, 193],
                    },
                ],
            },
            options2: {
                ...
                datasets: [
                    {
                        label: '家电',
                        data: [234, 278, 270, 190, 230, 274],
                    },
                    {
                        label: '百货',
                        data: [164, 178, 150, 135, 160, 142],
                    },
                    {
                        label: '食品',
                        data: [74, 118, 200, 235, 90, 103],
                    },
                ],
            },
        }
